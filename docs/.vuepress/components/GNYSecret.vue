<template>
  <div class="bip39-key-container">
    ...
    <textarea type="text" v-model="newBip39"></textarea>
...
export default {
  ...
  methods: {
    recalculate() {
      this.newBip39 = bip39.generateMnemonic();
    },
  },
  data: function() {
    return {
...
.bip39-key-container p {
  font-weight: 600;
  line-height: 1.7;
}

.bip39-key-container > input {
  line-height: 1.7rem;
}
